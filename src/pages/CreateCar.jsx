...
const CreateCar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Failed to save the car. Please check your network connection and try again."
      );
    }
  };

  return (
    <div className="create-car-page" style={{ padding: "32px" }}>
      <Breadcrumb />
      <h1 className="main-title fs-20 m-0 fw-bold mt-3 mb-3">Add New Car</h1>
